...
<body class="bg-white">
    <h2 class="text-center mt-5 fw-bold">For an improved learning and<br/>teaching experience!</h2>
    <div class="login-wrapper">
                
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-6">
                            <img src="<?php echo FRONT_SITE_PATH?>assets/img/login_bg.png" alt="Login Image for Students" width="100%">
                        </div>
                        <div class="col-12 col-lg-6">
                            <form class="login-form" method="post" id="student_login">
                                ...
                                <hr class="hr-light">
                                    ...
                                    <input class="form-control" type="email" placeholder="name@domain.com" name="student_email" id="s_mail">
                                    <label class="form-label mt-3">Your Password</label>
                                    <input class="form-control" type="password" placeholder="*********" name="student_password" id="s_pass">
                                <p class="text-end mt-2 mb-0"><small><a href="#">Forgot Password?</a></small></p>
                                <button class="btn btn-primary btn-block mt-4 btn-detail" type="submit">Log in</button>
                            </form>
                        </div>
                    </div>
                </div>
